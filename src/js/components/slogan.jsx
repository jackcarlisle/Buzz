    ...
    return (
      <div className='slogan-container'>
        ...
        <div className='slogan-text'>
          ...
          <div className='slogan-paragraph'>With so many new drinks appearing on the market, let us help you discover the finest amongst them, at an even better price!</div>
