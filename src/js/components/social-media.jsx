    ...
    return (
      <div className='row'>
        ...
        <a href="https://www.facebook.com/">
          <img className='icon-fb' src="http://vectorlogofree.com/wp-content/uploads/2014/07/25305-facebook-sign-of-letter-f-inside-a-black-rounded-square-shape-icon-vector-icon-vector-eps.png"/>
        </a>
